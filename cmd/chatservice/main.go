...
import (
	...
	"github.com/almerindopaixao/chat-service/configs"
	"github.com/almerindopaixao/chat-service/internal/infra/grpc/server"
	"github.com/almerindopaixao/chat-service/internal/infra/repository"
	"github.com/almerindopaixao/chat-service/internal/infra/web"
	"github.com/almerindopaixao/chat-service/internal/infra/web/webserver"
	"github.com/almerindopaixao/chat-service/internal/usecase/chatcompletion"
	"github.com/almerindopaixao/chat-service/internal/usecase/chatcompletionstream"
...
func main() {
	...
	fmt.Println("Server running on port " + configs.GRPCServerPort)
	...
	webserverChatHandler := web.NewWebChatGPTHanler(*usecase, chatConfig, configs.AuthToken)
